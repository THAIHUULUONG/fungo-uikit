...
<path fillRule="evenodd" clipRule="evenodd" d="M10.5 9H5.5C3.84315 9 2.5 10.3431 2.5 12V18C2.5 19.6569 3.84315 21 5.5 21H11.5C13.1569 21 14.5 19.6569 14.5 18V15H13.5V18C13.5 19.1046 12.6046 20 11.5 20H5.5C4.39543 20 3.5 19.1046 3.5 18V12C3.5 10.8954 4.39543 10 5.5 10H10.5V9Z" fill={theme.colors.text}/>
